...
public class TableCheck extends GenericCheck {
	...
	public void writeStatistics(String myFilePath) throws IOException {
		genericCheckStatistics.WriteStatisticsToGenericFileGood(myFilePath,(double)tableCheckStatistics.getTotalTables(),dataSetName);
		tableCheckStatistics.WriteStatisticsToFileGood(myFilePath,dataSetName);
		genericCheckStatistics.WriteStatisticsToGenericBadFile(myFilePath,(double)tableCheckStatistics.getTotalTables(),dataSetName);
